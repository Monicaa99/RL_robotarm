...
class ArmEnv(object):
    ...
    def inverse_kinematic(self):
        ...
        #q3= 2 * np.pi-np.arccos(np.dot(v1, v2) / (np.linalg.norm(v1) * np.linalg.norm(v2)))
        #q3=np.dot(,)
    ...
    def reset(self):
    	...
    	self.goal=dm.main("/home/monicapina/TFG/yolo/hmr/darknet/resultado.jpg")

        print("GOAL:" ,self.goal)
        self.ax.scatter(self.goal['x'],self.goal['y'],self.goal['z'],s=50)
