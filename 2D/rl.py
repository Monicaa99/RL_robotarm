...
class DDPG(object):
    def __init__(self, a_dim, s_dim, a_bound,):
        ...
        self.S = tf.placeholder(tf.float32, [None, s_dim], 's') # Para introducir datos en el gráfico.
    ...
    def choose_action(self, s):
        ...
        return self.sess.run(self.a, {self.S: s[None, :]})[0] #[,:] Hace referencia a filas.
    ...
    def learn(self):
        ...
        indices = np.random.choice(MEMORY_CAPACITY, size=BATCH_SIZE) #Para  cada estado escogemos acción aleatoria
